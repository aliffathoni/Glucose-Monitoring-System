...
// #define TFT_CS   9  // Chip select control pin (library pulls permanently low
// #define TFT_DC   8  // Data Command control pin - must use a pin in the range 0-31
// #define TFT_RST  7  // Reset pin, toggles on startup
